...
const idl = require("./idl.json"); // Replace with the path to your IDL file
const programId = new PublicKey("YOUR_PROGRAM_ID"); // Replace with your program ID

const wallet = new Keypair(); // Assume you're using a new keypair for the wallet
...
async function initVesting() {
    ...
    // Assume you have your own way of constructing and sending transactions
    // This part will vary based on your wallet provider or custom implementation
    // You need to construct and sign the transaction to invoke the initVesting function

    console.log(`Vesting account initialized: ${vestingState.publicKey}`);
}

// Helper function to claim the vested tokens
async function claimVesting(vestingStateKey) {
    ...
    if (currentTimestamp >= vestingState.vestingEnd.toNumber()) {
        ...
        // Assume you have your own way of constructing and sending transactions
        // This part will vary based on your wallet provider or custom implementation
        // You need to construct and sign the transaction to invoke the claimVesting function
